...
function create_structure() {
    ...
    mkdir -p "share/Data/Network_Mapping/Internal/Eyewitness/"
    mkdir -p "share/Data/Network_Mapping/Internal/Aquatone/"
    mkdir -p "share/Data/Network_Mapping/Internal/Nmap/"
    mkdir -p "share/Data/Network_Mapping/External/Eyewitness/"
    mkdir -p "share/Data/Network_Mapping/External/Nmap/"
    mkdir -p "share/Data/Network_Mapping/External/Aquatone/"
    mkdir -p "share/Data/Network_Mapping/External/OSINT/"
    mkdir -p "share/Data/Penetration_Test/Cobalt Strike/"
    mkdir -p "share/Data/Vulnerability_Scanning/External/Nessus/"
    mkdir -p "share/Data/Vulnerability_Scanning/External/Nikto/"
    mkdir -p "share/Data/Vulnerability_Scanning/Internal/Nessus/"
    mkdir -p "share/Data/Vulnerability_Scanning/Internal/Nikto/"
    mkdir -p "share/Data/Web_App/BurpSuite/"
    mkdir -p "share/Data/Web_App/Nikto/"
